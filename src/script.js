...
// ====>  Mapping shadow
// const directionalLightCamera = directionalLight.shadow.camera;
// const directionalLightCameraHelper = new THREE.CameraHelper(
//   directionalLightCamera
// );
// scene.add(directionalLightCameraHelper);
directionalLight.shadow.mapSize.width = 2014;
...
// directionalLight.shadow.camera.updateProjectionMatrix(); // kamera matrisini güncelle
...
const tick = () => {
  ...
  const intensity = Math.abs(flickTime);
  doorLight.intensity = 2 + intensity * 4;
